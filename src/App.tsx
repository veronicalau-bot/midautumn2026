...
const copy = {
  zh: {
    ...
    eyebrow: '學院圖書館', heroTitle: '這個中秋，同行於香港海濱的月下',
    ...
    routesTitle: '六段香港月色', routesText: '選擇路線，認識距離、交通與沿途特色。', transport: '前往方法', tip: '月下小貼士', chooseRoute: '用這條路線計算', openGoogleMaps: '在 Google Maps 開啟', mapLocked: '路線預覽已鎖定，避免誤拖離香港。', mapPending: '這條路線的 Google 地圖預覽準備中。你仍可在 Google Maps 查看步行方向。',
    safetyTitle: '夜跑安全注意', safetyText: '在出門前花一分鐘檢查。勾選內容只留在你的裝置。', before: '出發前', during: '途中', stop: '需要停止', checked: '項已準備',
  ...
  en: {
    ...
    eyebrow: 'Academy Libraries', heroTitle: 'This Mid-Autumn, walk together under Hong Kong’s waterfront moonlight',
    ...
    routesTitle: 'Six shades of Hong Kong moonlight', routesText: 'Choose a route for distance, transport and local tips.', transport: 'Getting there', tip: 'Moonlit tip', chooseRoute: 'Use this route', openGoogleMaps: 'Open in Google Maps', mapLocked: 'The route preview is locked to prevent accidental panning away from Hong Kong.', mapPending: 'The Google Maps preview for this route is being prepared. Walking directions are still available in Google Maps.',
    safetyTitle: 'Night running safety notes', safetyText: 'Take a minute before you leave. Your checklist stays on this device.', before: 'Before you go', during: 'On the way', stop: 'When to stop', checked: 'ready',
